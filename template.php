	...
	<body>
         ...
         <div class="line">
			...
			<header class="codrops-header">
				...
				<h1>EDDY GRAPHICS <span>a preview of some works</span></h1>
			</header>
			
			<section id="photostack-1" class="photostack photostack-start">
				<div>
					<figure>
						<a href="http://goo.gl/Qw3ND4" class="photostack-img"><img src="img/images (1).jpg" alt="img01"/></a>
						<figcaption>
							<h2 class="photostack-title">Serenity Beach</h2>
						</figcaption>
					</figure>
					<figure>
						<a href="http://goo.gl/fhwlSP" class="photostack-img"><img src="img/customised-hen-party-t-shirts-with-your-design-t-shirt-print-my-tops-760274.jpeg" alt="img02"/></a>
						<figcaption>
